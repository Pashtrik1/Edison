<template>
    <nav class="grid grid-rows-1 w-full px-5 absolute z-10">
        <header>
            <div class="flex flex-row flex-wrap justify-between relative h-[56px]">
                ...
                <div class="flex items-center w-[79px] lg:hidden">
                    ...
                    <ol class="hidden lg:flex flex-row justify-center items-center me-7">
                        <li class="flex duration-300 py-[4px] px-[8px] hover:bg-[#0000000D] rounded-lg invert"><button class=""><img src="../../../public/storage/mainpagecontent/icons/mark.png" alt=""></button></li>
                        <li class="flex duration-300 py-[4px] px-[8px] hover:bg-[#0000000D] rounded-lg invert"><button class=""><img src="../../../public/storage/mainpagecontent/icons/Glob.png" alt=""></button></li>
                        <li class="flex duration-300 py-[4px] px-[8px] hover:bg-[#0000000D] rounded-lg invert"><button class=""><img src="../../../public/storage/mainpagecontent/icons/User.png" alt=""></button></li>
                    </ol>
            </div>
        </header>
    </nav>
